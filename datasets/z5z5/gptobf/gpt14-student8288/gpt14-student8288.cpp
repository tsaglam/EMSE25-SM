...
class FourierovRed
{
    ...
    double T;
    int N;
    double b0; // Unused variable introduced
  ...
  FourierovRed &operator =(FourierovRed &&r)
  {
     ...
     ak = std::move(r.ak);
     bk = std::move(r.bk);
     int unused_var1 = 0; // Unused variable introduced
     return *this;
  };
  ...
  FourierovRed &operator =(const FourierovRed &r)
  {
     ...
     double unused_var2 = 0.0; // Unused variable introduced
     return *this;
  };
  ...
  double operator ()(double x)
  {
      ...
      double unused_var3 = 0.0; // Unused variable introduced
      return rezultat;
  };
