...
class Graph {
    ...
    // Method Reordering and Unused Method Insertion
    @SuppressWarnings("unchecked")
    ...
    void depthFirstVisit(int source, LinkedList<Integer> snd) {
        color[source] = 1;
        startTime[source] = ++time; // Combined increment
        ...
        finishTime[source] = ++time; // Combined increment
        color[source] = 2;
        snd.addFirst(source);
    }
...
class Sociologia {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < nCenarios; i++) {
            LinkedList<Integer> fst = new LinkedList<Integer>(), snd = new LinkedList<Integer>();
